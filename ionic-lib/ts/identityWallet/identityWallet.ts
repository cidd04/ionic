...
import { createIonicRegistry } from '../registries/ionicRegistry'
...
export class IdentityWallet {
   ...
   * @example `iw.getPublicKeys('secret')` // { ionicIdentityKey: '0xabc...ff', ethereumKey: '0xabc...ff'}
   */
  ...
  public async validateJWT<T extends JWTEncodable, A extends JWTEncodable>(
    ...
    const registry = customRegistry || createIonicRegistry()
