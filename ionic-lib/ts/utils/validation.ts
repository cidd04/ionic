 ...
 * @param customRegistry - Custom registry implementation. If null, the {@link IonicRegistry} is used
...
export const validateDigestable = async (
  ...
  const reg = customRegistry || IonicLib.registries.ionic.create()
  ...
  try {
    ...
    return IonicLib.KeyProvider.verifyDigestable(issuerPublicKey, toValidate)
  } catch {
    return false
  }
}
