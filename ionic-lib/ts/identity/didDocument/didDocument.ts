...
import { defaultContextDid } from '../../utils/contexts'
...
export class DidDocument implements IDigestable {
  ...
  private '_@context': ContextEntry = defaultContextDid
   ...
   * @example `console.log(didDocument.issuanceDate) // Date 2018-11-11T15:46:09.720Z`
   */
