...
export class SignedCredential implements IDigestable {
  ...
  private _credentialSubject: IClaimSection = {}
   ...
   * @example `console.log(signedCredential.issuanceDate) // Date 2018-11-11T15:46:09.720Z`
   */
   ...
   * @example `signedCredential.issuanceDate = new Date('2018-11-11T15:46:09.720Z')`
   */

  set issuanceDate(issuanceDate: Date) {
   ...
   * @example `console.log(signedCredential.credentialSubject) // { id: 'did:jolo:abcde', name: 'Example' }`
   */
   ...
   * @example `signedCredential.credentialSubject = { id: 'did:jolo:abcde', name: 'Example' }`
   */

  set credentialSubject(credentialSubject: IClaimSection) {
