...
export class SoftwareKeyProvider implements IVaultedKeyProvider {
  ...
  public getPublicKeyAsync(derivationArgs: IKeyDerivationArgs): Promise<Buffer> {
      return
  }
  ...
  public signAsync(derivationArgs: IKeyDerivationArgs, digest: Buffer): Promise<Buffer> {
      return
  }
  ...
  public getPrivateKeyAsync(derivationArgs: IKeyDerivationArgs): Promise<Buffer> {
      return
  }
